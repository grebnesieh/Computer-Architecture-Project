...
// load-arithmetic-arithmetic
// arithmetic-arithmetic-arithmetic
// invalid op - leads to address 27
// 2 cache accesses, set 0 and 2, both cold misses
...
assign instruction[10] = 32'b100_101_01011_01000__000_110_00110_01101; // R[5] >>= (circular) R[4]; || R[6] = Mem[6];
assign instruction[11] = 32'b100_100_100_00_00011__0000000000011111; // R[4] = R[4] + R[4]; INTENTIONAL INVALID
...
assign instruction[28] = 32'b0000000000000000__111_110_11011_01101; // R[6] = Mem[54 + 27] COLD MISS! 32 cycle stall